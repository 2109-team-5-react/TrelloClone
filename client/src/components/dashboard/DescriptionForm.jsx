...
const DescriptionForm = ({ card, id }) => {
  ...
  return (
    <form className="description">
      ...
      : <><textarea className="textarea-toggle" rows="1" value={cardDescription} autoFocus={true} onChange={handleDescriptionChange}></textarea>
        <div>
          <div className="button" value="Save" onClick={handleSubmitDescription}>
            Save
          </div>
